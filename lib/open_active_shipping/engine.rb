...
module OpenActiveShipping
  class Engine < Rails::Engine
    ...
    engine_name 'open_active_shipping'

    config.autoload_paths += %W(#{config.root}/lib)

    initializer 'open_active_shipping.environment', before: :load_config_initializers do |app|
      Spree::ActiveShipping::Config = OpenActiveShippingConfiguration.new
    end
    ...
    initializer 'open_active_shipping.register.calculators', after: 'spree.register.calculators' do |app|
