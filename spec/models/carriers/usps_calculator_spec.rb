...
describe Spree::Calculator::Shipping::Usps do
  ...
  describe 'compute' do
    ...
    it 'uses the carrier supplied in the initializer' do
      expect(subject).to eq 14.1
    end

    context 'with valid response' do
      it "returns rate based on calculator's service_code" do
      ...
      it 'returns nil if service_code is not found in rate_hash' do
  ...
  describe 'service_name' do
    it 'returna description when not defined' do
